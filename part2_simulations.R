...
for (version in 1:2){
  ...
  tot$t[tot$time==1]<-"Time interval 1"
  tot$t[tot$time==2]<-"Time interval 2"
  tot$t[tot$time==3]<-"Time interval 3"
  tot$t[tot$time==4]<-"Time interval 4"
  ...
  g<-
    ...
    scale_color_manual(
      values = c("Empirical" = "blue", "Wrong model" = "red"),
